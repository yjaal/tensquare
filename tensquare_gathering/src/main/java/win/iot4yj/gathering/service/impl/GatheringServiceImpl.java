package win.iot4yj.gathering.service.impl;
...
import win.iot4yj.gathering.dao.GatheringDao;
import win.iot4yj.gathering.pojo.Gathering;
import win.iot4yj.gathering.service.GatheringService;
...
public class GatheringServiceImpl implements GatheringService {
	 ...
	 * value:缓存名称
	 * key:参数id
	 * 存入concurrentMap中的key为 value+id
	 * value为 Gathering对象
	 * 根据ID查询实体
	 *
	 * @param id
	 * @return
	 */
	@Cacheable(value = "gathering", key = "#id")//存入的注解
	 ...
	 * @param gathering
	 */
	@CacheEvict(value = "gathering", key = "#gathering.id")//删除的注解
